...
summary: We introduce a novel 3D modeling task that generates 3D shapes presenting geometric shapes and appearances that conform to different semantics when observed from different views.
tags:
  - 3D Generation
  - 3DGS
