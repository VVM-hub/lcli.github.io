...
organizations:
  - name: USTC
    url: https://en.ustc.edu.cn/Schools.htm

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto:liangchen@mail.ustc.edu.cn'
    label: E-mail Me
  # - icon: brands/x
  ...
  - icon: brands/github
    url: https://github.com/VVM-hub
  # - icon: brands/linkedin
  #   url: https://www.linkedin.com/
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=m8B8IZUAAAAJ&hl=en&authuser=1&scioq=Liangchen+Li
  - icon: academicons/orcid
    url: https://orcid.org/0009-0004-8176-0745
